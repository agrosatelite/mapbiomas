...
#FEATURE_WRS_FILTER = [216072, 216073, 215073, 215072, 216074, 215074]
FEATURE_WRS_FILTER = [214067, 214066, 215066, 215067]
...
CLASSIFIER_CLASS = processors.ClassifierFixBounds
...
EXPORT_DIRECTORY = 'classification/annual/caatinga_correcao/2016'
EXPORT_MAX_TASKS = 3
EXPORT_INTERVAL = 30
EXPORT_MAX_ERRORS = 1
EXPORT_BUFFER = -4200
